...
export default function Footer () {
    return (
        <footer className="flex justify-center mt-8 bg-red-50/20">
            <div className="grid grid-cols-1 md:grid-cols-2 w-full px-4 md:px-16 py-4 pb-8 md:pb-4">
                ...
                <div className="flex flex-col items-center md:items-start md:flex-row text-neutral-700 md:space-x-24">
                    <div className="flex flex-col space-y-4 mt-16 md:mt-0 justify-center items-center md:items-start md:justify-start">
                        <p className="cursor-default text-lg font-semibold text-center md:text-start">Booking</p>
                        <div className="flex flex-col justify-center md:justify-start space-y-4 leading-4 text-neutral-500 w-32">
                            <a className="hover:text-neutral-800 cursor-pointer text-center md:text-start" href="/booking/bordresevationer">Bordresevationer</a>
                            <a className="hover:text-neutral-800 cursor-pointer text-center md:text-start" href="/booking/billetsalg">Billetsalg</a>
                            <a className="hover:text-neutral-800 cursor-pointer text-center md:text-start" href="/booking/lej-oscar">Lej Oscar</a>
                        </div>
                    </div>
                    <div className="flex flex-col space-y-4 mt-16 md:mt-0 justify-center items-center md:items-start md:justify-start">
                        <p className="cursor-default text-lg font-semibold text-center md:text-start">Events</p>
                        <div className="flex flex-col space-y-4 leading-4 text-neutral-500 w-32 justify-center md:justify-start">
                            <a className="hover:text-neutral-800 cursor-pointer text-center md:text-start" href="/events/das_mädchen">Das Mädchen</a>
                            <a className="hover:text-neutral-800 cursor-pointer text-center md:text-start" href="/events/christian_andersen_band">Christian Andersen band</a>
                            <a className="hover:text-neutral-800 cursor-pointer text-center md:text-start" href="/events/sanne_bentsen">Sanne Bentsen</a>
                        </div>
                    </div>
                    <div className="flex flex-col space-y-4 mt-16 md:mt-0 justify-center md:justify-start">
                        <a className="cursor-pointer hover:text-neutral-900 text-lg font-semibold text-center md:text-start" href="/kontakt">Kontakt</a>
                    </div>
                </div>
            </div>
        </footer>
