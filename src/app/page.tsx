        ...
        <div className="flex flex-col w-full items-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 space-x-4 space-y-4 mt-12">
                <div className="features group cursor-default">
                    <div className="flex justify-center">
                        <svg className="text-slate-900 group-hover:text-white text-center w-12 h-12" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
            ...
            <aside className="aside">
                <div className="asideleftimage">
                    <Image width={10000} height={10000} className="object-cover h-full w-full" src="/public/stemning.jpeg" alt="rock koncert"/>
                </div>
                <div>
            ...
            <aside className="aside">
                ...
                <div className="asiderightimage">
                    <Image width={10000} height={10000} className="object-cover h-full w-full" src="/public/stemning3.jpeg" alt="rock koncert"/>
                </div>
            </aside>
        </div>
    </main>
